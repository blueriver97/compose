...
SERVER_JVMFLAGS="-Xlog:gc*:file=$ZOO_LOG_DIR/zookeeper_gc-%t.log:tags,time,uptime,level:filecount=5,filesize=2M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/data/zookeeper"
