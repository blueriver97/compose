...
#JMX Option
YARN_JMX_OPTS="-javaagent:/opt/hadoop/jmx_exporter/jmx_prometheus_javaagent-1.4.0.jar=7071:/opt/hadoop/jmx_exporter/hadoop.yaml"
#GC Option
YARN_GC_OPTS="-Xlog:gc*:file=/var/log/yarn/resourcemanager_gc-%t.log:tags,time,uptime,level:filecount=5,filesize=2M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/data/yarn"
export YARN_RESOURCEMANAGER_OPTS="${YARN_JMX_OPTS} ${YARN_GC_OPTS}"
