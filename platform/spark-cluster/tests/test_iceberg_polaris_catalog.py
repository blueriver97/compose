...
spark = (
    ...
    .config(f"spark.sql.catalog.{CATALOG}.uri", "http://polaris:8181/api/catalog")
    .config(f"spark.sql.catalog.{CATALOG}.oauth2-server-uri", "http://polaris:8181/api/catalog/v1/oauth/tokens")
