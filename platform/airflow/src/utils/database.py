...
# --- JDBC Utilities ---
def get_jdbc_options(config: Settings, database: Optional[str] = None) -> Dict[str, str]:
...
def get_partition_key_info(spark: SparkSession, config: Settings, database: Optional[str] = None) -> Dict[str, str]:
    """
